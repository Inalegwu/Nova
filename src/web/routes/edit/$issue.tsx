    ...
    <div className='flex w-full h-full p-2 gap-2'>
      <div className='h-full w-4/6 flex flex-col items-start p-6 justify-center space-y-5'>
        <div className='flex items-center justify-between w-full'>
          ...
          {isOnline && (
            <Button className='flex items-center justify-center gap-1 bg-neutral-100 dark:bg-neutral-900 p-2'>
              <CloudDownload weight='BoldDuotone' size={18} />
            </Button>
          )}
        </div>
        <div className='flex flex-col gap-2'>
          <span className='text-sm text-neutral-400 p-3 bg-neutral-50 dark:bg-neutral-950 space-y-2 rounded-xl'>
      ...
      <div className='h-full w-2/6 flex p-4 '>
